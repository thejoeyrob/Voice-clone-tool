const CACHE='jw-eds-audio-v1.3.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./hero.jpg','./robbos-trakway-trivia.json'];
